...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer.from_argparse_args(hparams, default_root_dir=hparams.exp_name,gpus=hparams.GPULst,
                                            ...
                                            gradient_clip_val=hparams.gradient_clip_val, strategy = DDPStrategy(find_unused_parameters=True if hparams.degradation_mode=='inpainting' else False) if len(hparams.GPULst)>1  else None,
